<template>
	<div class="developing_new">
        ...
        <div class="right_home_warp but_pad test-1">
            <form action="">
                ...
                <ul class="form_ul">
                    ...
                    <li>
                        <label>身份证号码:</label><input type="text" placeholder="请输入身份证号码" v-model="userInfo.idCardNo" />
                    </li>
                    <!--<li>
                ...
                <div class="form_div_js">
                    <div class="power_le">员工角色</div>
                    <div class="power_ri_box">
                        <div class="power_ri">
                            <!--<input type="checkbox"  /><label>{{item}}</label>-->
                            <Row>
                                <Col span="5" v-for="(item,index) in bxa" :key="index">
                ...
                <!--账户角色-->
                <div class="form_div_three" v-for="(item_le,index) in list_le" :key="index">
                    ...
                    <div class="power_ri_box_three">
                        ...
                        <Row>
                            <Col span="4" v-for="(ri,index) in item_le.list_ri" :key="index">
